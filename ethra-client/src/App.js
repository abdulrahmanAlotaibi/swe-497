...
function App() {
    return ( <
        ...
        /> <
        Route exact path = "/course-modification/:id"
        render = {
            (props) => ( <
                MyContext.Consumer > {
                    (context) => ( <
        ...
        /> <
        Route exact path = "/topic-modification/:id"
        render = {
            (props) => ( <
                MyContext.Consumer > {
                    (context) => ( <
        ...
        /> <
        Route path = "/visitor-tutor-profile/"
        render = {
            () => ( <
                MyContext.Consumer > {
                    (context) => ( <
        ...
        <
        Route exact path = { `/course-manager/:id` }
        render = {
            (props) => {
                return ( <
                        MyContext.Consumer > {
    ...
    /> <
    Route exact path = { `/topic-manager/:id` }
    render = {
        (props) => {
            return ( <
                    MyContext.Consumer > {
...
<
Route exact path = { `/streams/:id/post` }
render = {
    (props) => {
        return ( <
                MyContext.Consumer > {
