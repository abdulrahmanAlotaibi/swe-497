...
export default class extends Component {
  ...
  deleteCourse = async (id, i) => {
    try {
      await axios.delete(`https://ethra.herokuapp.com/admin/delete-course/${id}`);
  ...
  toggleSuspention = async (id, i) => {
    try {
      ...
      await axios.patch(`https://ethra.herokuapp.com/admin/suspend-course/${id}`);
  ...
  toggleBannation = async (id, i) => {
    try {
      ...
      await axios.patch(`https://ethra.herokuapp.com/admin/ban/${type}/${id}`);
  ...
  getData = async () => {
    const students = await axios.get("https://ethra.herokuapp.com/admin/students");
    const tutors = await axios.get("https://ethra.herokuapp.com/admin/tutors");
    const courses = await axios.get("https://ethra.herokuapp.com/admin/courses");
