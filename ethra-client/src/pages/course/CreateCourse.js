...
export default class CreateCourse extends Component {
  ...
  async handleSubmit(evt) {
    try {
      ...
      const formattedType = JSON.stringify("course");
      fd.append("photo", img);
      fd.append("name", name);
      ...
      //   chapters
      // };
      await axios.post("http://localhost:8000/course/create-course", fd, {
  ...
  render() {
    ...
    return (
      <section className="form-section">
        <h2 className="form-section__heading">Create A Course</h2>
